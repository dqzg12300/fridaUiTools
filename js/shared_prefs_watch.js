Java.perform(function () {
    console.log('[shared_prefs_watch] init');
    ...
    try {
        ...
        getString.implementation = function (key, defValue) {
            ...
            console.log('[shared_prefs_watch] getString => key=' + key + ', value=' + stringify(result));
            return result;
        };
        ...
        getInt.implementation = function (key, defValue) {
            ...
            console.log('[shared_prefs_watch] getInt => key=' + key + ', value=' + result);
            return result;
        };
        ...
        getLong.implementation = function (key, defValue) {
            ...
            console.log('[shared_prefs_watch] getLong => key=' + key + ', value=' + result);
            return result;
        };
        ...
        getBoolean.implementation = function (key, defValue) {
            ...
            console.log('[shared_prefs_watch] getBoolean => key=' + key + ', value=' + result);
            return result;
        };
        ...
        getFloat.implementation = function (key, defValue) {
            ...
            console.log('[shared_prefs_watch] getFloat => key=' + key + ', value=' + result);
            return result;
        };
    } catch (e) {
        console.log('[shared_prefs_watch] SharedPreferencesImpl hook failed: ' + e);
    }
    ...
    try {
        ...
        putString.implementation = function (key, value) {
            console.log('[shared_prefs_watch] putString => key=' + key + ', value=' + stringify(value));
        ...
        putInt.implementation = function (key, value) {
            console.log('[shared_prefs_watch] putInt => key=' + key + ', value=' + value);
        ...
        putLong.implementation = function (key, value) {
            console.log('[shared_prefs_watch] putLong => key=' + key + ', value=' + value);
        ...
        putBoolean.implementation = function (key, value) {
            console.log('[shared_prefs_watch] putBoolean => key=' + key + ', value=' + value);
        ...
        putFloat.implementation = function (key, value) {
            console.log('[shared_prefs_watch] putFloat => key=' + key + ', value=' + value);
